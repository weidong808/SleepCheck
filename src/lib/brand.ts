export const APP_NAME = "SleepCheck";
export const APP_TAGLINE = "Ease your mind into sleep";
export const APP_DESCRIPTION =
  "A calm wind-down companion — gentle soundscapes, bedtime stories, guided breathing, and a sleep timer. Your preferences stay on your device.";
export const APP_URL = "https://sleepcheck.weidong-shi.com";

/** Personal site hub that links to SleepCheck and other projects. */
